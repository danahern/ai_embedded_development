---
paths: ["**/*appkit-e7*.dts", "**/*appkit-e8*", "**/alif-e7/**", "**/jlink*", "**/platform_def.h", "**/sdkconfig.defaults", "**/setools/**", "**/wifi_prov_wifi_esp*", "claude-mcps/alif-flash/**/server.py"]
---
# Hardware Learnings
...
- **Alif E7: J-Link writes to OSPI and MRAM are overwritten by SE on every boot** — ## Discovery
